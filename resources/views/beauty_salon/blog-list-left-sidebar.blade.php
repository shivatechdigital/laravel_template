        ...
        <div class="dlab-bnr-inr dlab-bnr-inr overlay-primary bg-pt" style="background-image:url({{ asset('beauty_salon/images/banner/bnr1.jpg') }});">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">Blog List Left Sidebar</h1>
					<!-- Breadcrumb row -->
        ...
        <div class="content-area">
            <div class="container">
                <div class="row justify-content-center">
					<div class="col-lg-4 col-md-12 sticky-top order-lg-1 order-2">
                    ...
                    <!-- Left part start -->
                    <div class="col-lg-8 col-md-12 m-b10 order-lg-2 order-1">
